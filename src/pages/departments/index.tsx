...
export default function Departments() {
  ...
  open={isOpen}
  onClose={handleClose}
  title={isEdit ? "Fakultetni tahrirlash" : "Fakultet qo'shish"}
>
  <form
  ...
  >
    ...
    <div className="flex flex-col gap-2">
      <Label className="dark:text-white">Fakultet</Label>
    ...
    <div className="flex flex-col gap-2">
      ...
      <Input
        ...
        className="dark:bg-[#141414] dark:text-white dark:border-gray-700"
        {...register("name", {
    ...
    <div className="flex justify-end gap-2">
      <Button
        ...
        variant="outline"
        onClick={handleClose}
        className="dark:border-gray-700 dark:text-white dark:hover:bg-[#141414]"
      >
        Bekor qilish
      </Button>
